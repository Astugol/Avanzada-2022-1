...
RUTA_UI_VENTANA_JUEGO = os.path.join( "assets", "ventana_juego.ui")
RUTA_UI_VENTANA_POSTJUEGO = os.path.join("assets",
                                         "ventana_postjuego.ui")
RUTA_TOPO = os.path.join('assets', 'topo.png')
RUTA_MARTILLO = os.path.join('assets', 'martillo.png')

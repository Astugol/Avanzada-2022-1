...
if __name__ == '__main__':
    ...
    # COMPLETAR
    ventana_inicio.senal_enviar_login.connect(LogicaInicio.comprobar_usuario)
    logica_inicio.senal_respuesta_validacion.connect(VentanaInicio.recibir_validacion)
    logica_inicio.senal_abrir_juego.connect(VentanaJuego.mostrar_ventana)
    ventana_inicio.show()
    app.exec()
